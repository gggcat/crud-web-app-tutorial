  ...
  return (
    <div className="max-w-4xl mx-auto p-2">
      ...
      <div className="flex flex-col md:flex-row gap-2 mb-4">
        ...
        />
        <button
          className="bg-blue-600 text-white rounded px-4 py-1 hover:bg-blue-700 transition disabled:opacity-50"
      ...
      <div className="overflow-x-auto bg-white rounded shadow">
        <table className="min-w-full border-collapse block md:table">
          <thead className="block md:table-header-group bg-gray-50 sticky top-0 z-10">
            <tr className="block md:table-row">
              <th className="p-2 text-left font-medium block md:table-cell">商品コード</th>
              <th className="p-2 text-left font-medium block md:table-cell">商品名</th>
              <th className="p-2 text-left font-medium block md:table-cell">在庫数量</th>
              <th className="p-2 text-center font-medium block md:table-cell w-24">操作</th>
            </tr>
          </thead>
          <tbody className="block md:table-row-group">
            {stocks.map(row => (
              ...
              >
                <td className="p-2 block md:table-cell align-middle">{row.stock_code}</td>
                ...
                <td className="p-2 block md:table-cell align-middle text-center">
                  {editingId === row.stock_code ? (
